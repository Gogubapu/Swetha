...
@Query("SELECT e FROM Employeee e WHERE e.firstname like %?1%" + "OR e.lastname like %?1%" + "OR e.email like %?1%" + "OR CONCAT(e.id, '') like %?1%" + "OR e.location like %?1%" + "OR e.designation like %?1%")
@NotNull
